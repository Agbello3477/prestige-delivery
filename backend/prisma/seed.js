...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var kano, adminPassword, admin, existingPricing, kanoPricing;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma.state.upsert({
                        where: { name: 'Kano' },
                        update: {},
                        create: {
                            name: 'Kano',
                ...
                case 3:
                    ...
                    return [4 /*yield*/, prisma.pricingModule.findFirst({
                            where: { stateId: kano.id }
                        })];
                case 4:
                    existingPricing = _a.sent();
                    if (!!existingPricing) return [3 /*break*/, 6];
                    return [4 /*yield*/, prisma.pricingModule.create({
                            data: {
                                stateId: kano.id,
                                baseFare: 500, // Naira
                                perKmRate: 100, // Naira
                ...
                case 5:
                    kanoPricing = _a.sent();
                    console.log({ kanoPricing: kanoPricing });
                    return [3 /*break*/, 7];
                case 6:
